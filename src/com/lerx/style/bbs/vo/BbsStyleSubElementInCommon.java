...
public class BbsStyleSubElementInCommon implements Cloneable{
	/**
	 * 
	 */
	...
	private String bmDataFormat;
	private String titleOfMajorLoopCodeInLump;	//主循环体顶部
	private String titleOfMinorLoopCodeInLump; 	//副循环体顶部
	...
	public String getBmDataFormat() {
		return bmDataFormat;
	}

	public void setBmDataFormat(String bmDataFormat) {
		this.bmDataFormat = bmDataFormat;
	}

	public String getTitleOfMajorLoopCodeInLump() {
		return titleOfMajorLoopCodeInLump;
	}

	public void setTitleOfMajorLoopCodeInLump(String titleOfMajorLoopCodeInLump) {
		this.titleOfMajorLoopCodeInLump = titleOfMajorLoopCodeInLump;
	}

	public String getTitleOfMinorLoopCodeInLump() {
		return titleOfMinorLoopCodeInLump;
	}

	public void setTitleOfMinorLoopCodeInLump(String titleOfMinorLoopCodeInLump) {
		this.titleOfMinorLoopCodeInLump = titleOfMinorLoopCodeInLump;
	}
