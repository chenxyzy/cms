...
public class QaStyleSubElementInCommon {
	private Integer id;
	...
	private String itemsLoopFormat;	//问题列表
	private String itemsLoopFormatNoStateInf;
	private String navsLoopFormat;
	/*
	...
	public String getItemsLoopFormat() {
		return itemsLoopFormat;
	}
	public void setItemsLoopFormat(String itemsLoopFormat) {
		this.itemsLoopFormat = itemsLoopFormat;
	}
	public String getItemsLoopFormatNoStateInf() {
		return itemsLoopFormatNoStateInf;
	}
	public void setItemsLoopFormatNoStateInf(String itemsLoopFormatNoStateInf) {
		this.itemsLoopFormatNoStateInf = itemsLoopFormatNoStateInf;
	}
	public String getNavsLoopFormat() {
		return navsLoopFormat;
	}
	public void setNavsLoopFormat(String navsLoopFormat) {
		this.navsLoopFormat = navsLoopFormat;
	}
