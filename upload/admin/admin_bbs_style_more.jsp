...
<div class="aebox">
 <div class="aeheadbox">
  ...
  <div class="aeheadm">>　“<s:property value="#request.currentStyleName"/>”——论坛风格模板详情</div>
 ...
 <tr>
   ...
   <tr >
    ...
    <td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_bbs_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=基本&id='+<s:property  value="#request.styleID"/>+'&col=${x.colName}&table=bbs_style');">详情</a></td>
...
<s:action name="admin_bbs_style_getMetaDataByID" >
	<s:param name="id"><s:property  value="#request.pid"/></s:param>
	<s:param name="table">bbs_style_element</s:param>
</s:action>
...
<tr >
    ...
    <td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_bbs_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=public&id='+<s:property  value="#request.pid"/>+'&col=${xp.colName}&table=bbs_style_element');">详情</a></td>
...
<td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_bbs_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=index&id='+<s:property  value="#request.iid"/>+'&col=${xp.colName}&table=bbs_style_element');">详情</a></td>

   </tr>
</s:iterator>
<tr>
    <td height="30" colspan="4">forum分类页模块 </td>
 </tr>
<s:action name="admin_bbs_style_getMetaDataByID" >
	<s:param name="id"><s:property  value="#request.fid"/></s:param>
	<s:param name="table">bbs_style_element</s:param>
</s:action>
<s:iterator value="#request.metaData" id="xp" status="stp">  
<tr >
...
<td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_bbs_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=forum&id='+<s:property  value="#request.fid"/>+'&col=${xp.colName}&table=bbs_style_element');">详情</a></td>

   </tr>
</s:iterator>

<tr>
    <td height="30" colspan="4">theme主题页模块</td>
 </tr>
<s:action name="admin_bbs_style_getMetaDataByID" >
...
<td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_bbs_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=thread&id='+<s:property  value="#request.tid"/>+'&col=${xp.colName}&table=bbs_style_element');">详情</a></td>

   </tr>
</s:iterator>

<tr>
    <td height="30" colspan="4">edit增加或修改模块</td>
 </tr>
<s:action name="admin_bbs_style_getMetaDataByID" >
...
<td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_bbs_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=edit&id='+<s:property  value="#request.eid"/>+'&col=${xp.colName}&table=bbs_style_element');">详情</a></td>

   </tr>
</s:iterator>

    <td height="30" colspan="4">GenericStyle通用模块</td>
 </tr>
<s:action name="admin_bbs_style_getMetaDataByID" >
	<s:param name="id"><s:property  value="#request.gid"/></s:param>
	<s:param name="table">bbs_style_element</s:param>
</s:action>
<s:iterator value="#request.metaData" id="xp" status="stp">  
<tr >
...
<td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_bbs_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=Generic&id='+<s:property  value="#request.gid"/>+'&col=${xp.colName}&table=bbs_style_element');">详情</a></td>
...
<td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_bbs_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=search&id='+<s:property  value="#request.sid"/>+'&col=${xp.colName}&table=bbs_style_element');">详情</a></td>
