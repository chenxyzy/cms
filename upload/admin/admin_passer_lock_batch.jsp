...
.trlist .list_1,.trlist .list_2,.trlist .list_3,.trlist .list_4,.trlist .list_5,.trlist .list_6,.trlist .list_7,.trlist .list_8
	...
	<div class="aeheadm">> 审核员信息批量锁定</div>
	...
	<div class="aeheadbox">
	<div class="aeheadl"></div>
	<div class="aeheadm">> 批量对所有审核员信息中的部分内容进行锁定</div>
	<div class="aeheadr"></div>
	</div>
	<div class="aelist"><s:property value="actionErrors[0]" />
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<form method="POST"
			action="admin_passer_lockBatch.action">
		<tr>
			<td class="list_7">审核员信息1：</td>
			<td class="list_8"><input
				type="checkbox" name="pluv.lockInf1" value="true" 
				>锁定 </td>
		</tr>
		<tr>
			<td class="list_7">审核员信息2：</td>
			<td class="list_8"><input
				type="checkbox" name="pluv.lockInf2" value="true" 
				>锁定 </td>
		</tr>
		<tr>
			<td class="list_7">注入信息1：</td>
			<td class="list_8"><input
				type="checkbox" name="pluv.lockPriTag1" value="true" 
				>锁定 </td>
		</tr>
		<tr>
			<td class="list_7">注入信息2：</td>
			<td class="list_8"><input
				type="checkbox" name="pluv.lockPriTag2" value="true" 
				>锁定 </td>
		</tr>
	</table>
	</div>
