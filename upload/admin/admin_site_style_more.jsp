...
<div class="aebox">
 <div class="aeheadbox">
  ...
  <div class="aeheadm">>　“<s:property value="#request.currentStyleName"/>”——主站风格模板详情</div>
 ...
 <tr>
   ...
   <tr >
    ...
    <%
   // String tmp=java.net.URLEncoder.encode("基本","utf-8"); 
  //使用URLEncoder.encode方法 
  
  
 // str = URLEncoder.encode(str,"UTF-8"); 
    %>
    <td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_site_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=basic&id='+<s:property  value="#request.styleID"/>+'&col=${x.colName}&table=site_style');">详情</a></td>
...
<s:action name="admin_site_style_getMetaDataByID" >
	<s:param name="id"><s:property  value="#request.pid"/></s:param>
	<s:param name="table">site_style_element</s:param>
</s:action>
...
<tr >
    ...
    <td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_site_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=public&id='+<s:property  value="#request.pid"/>+'&col=${xp.colName}&table=site_style_element');">详情</a></td>
...
<tr>
    <td height="30" colspan="4">genericStyle通用页模块</td>
 </tr>
<s:action name="admin_site_style_getMetaDataByID" >
	<s:param name="id"><s:property  value="#request.mid"/></s:param>
	<s:param name="table">site_style_element</s:param>
</s:action>
<s:iterator value="#request.metaData" id="xp" status="stp">  
<tr >
...
<td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_site_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=generic&id='+<s:property  value="#request.gid"/>+'&col=${xp.colName}&table=site_style_element');">详情</a></td>
	
   </tr>
</s:iterator>

<tr>
    <td height="30" colspan="4">index首页模块 </td>
 </tr>
<s:action name="admin_site_style_getMetaDataByID" >
...
<td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_site_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=index&id='+<s:property  value="#request.iid"/>+'&col=${xp.colName}&table=site_style_element');">详情</a></td>

   </tr>
</s:iterator>
<tr>
    <td height="30" colspan="4">class分类页模块 </td>
 </tr>
<s:action name="admin_site_style_getMetaDataByID" >
	<s:param name="id"><s:property  value="#request.cid"/></s:param>
	<s:param name="table">site_style_element</s:param>
</s:action>
<s:iterator value="#request.metaData" id="xp" status="stp">  
<tr >
...
<td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_site_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=class&id='+<s:property  value="#request.cid"/>+'&col=${xp.colName}&table=site_style_element');">详情</a></td>

   </tr>
</s:iterator>
<tr>
    <td height="30" colspan="4">article文章页模块</td>
 </tr>
<s:action name="admin_site_style_getMetaDataByID" >
	<s:param name="id"><s:property  value="#request.tid"/></s:param>
	<s:param name="table">site_style_element</s:param>
</s:action>
<s:iterator value="#request.metaData" id="xp" status="stp">  
<tr >
...
<td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_site_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=article&id='+<s:property  value="#request.tid"/>+'&col=${xp.colName}&table=site_style_element');">详情</a></td>

   </tr>
</s:iterator>

<tr>
    <td height="30" colspan="4">reg注册页模块</td>
 </tr>
<s:action name="admin_site_style_getMetaDataByID" >
...
<td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_site_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=reg&id='+<s:property  value="#request.rid"/>+'&col=${xp.colName}&table=site_style_element');">详情</a></td>

   </tr>
</s:iterator>
<tr>
    <td height="30" colspan="4">userCenter用户中心模块</td>
 </tr>
<s:action name="admin_site_style_getMetaDataByID" >
	<s:param name="id"><s:property  value="#request.uid"/></s:param>
	<s:param name="table">site_style_element</s:param>
</s:action>
<s:iterator value="#request.metaData" id="xp" status="stp">  
<tr >
...
<td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_site_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=userCenter&id='+<s:property  value="#request.uid"/>+'&col=${xp.colName}&table=site_style_element');">详情</a></td>

   </tr>
</s:iterator>
<tr>
    <td height="30" colspan="4">login登录页模块</td>
 </tr>
<s:action name="admin_site_style_getMetaDataByID" >
	<s:param name="id"><s:property  value="#request.lid"/></s:param>
	<s:param name="table">site_style_element</s:param>
</s:action>
<s:iterator value="#request.metaData" id="xp" status="stp">  
<tr >
...
<td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_site_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=login&id='+<s:property  value="#request.lid"/>+'&col=${xp.colName}&table=site_style_element');">详情</a></td>

   </tr>
</s:iterator>

<tr>
    <td height="30" colspan="4">articleAdd增加文章页模块</td>
 </tr>
<s:action name="admin_site_style_getMetaDataByID" >
	<s:param name="id"><s:property  value="#request.aid"/></s:param>
	<s:param name="table">site_style_element</s:param>
</s:action>
<s:iterator value="#request.metaData" id="xp" status="stp">  
<tr >
...
<td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_site_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=articleAdd&id='+<s:property  value="#request.aid"/>+'&col=${xp.colName}&table=site_style_element');">详情</a></td>

   </tr>
</s:iterator>

<tr>
    <td height="30" colspan="4">articleEdit修改文章页模块</td>
 </tr>
<s:action name="admin_site_style_getMetaDataByID" >
	<s:param name="id"><s:property  value="#request.eid"/></s:param>
	<s:param name="table">site_style_element</s:param>
</s:action>
<s:iterator value="#request.metaData" id="xp" status="stp">  
<tr >
...
<td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_site_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=articleEdit&id='+<s:property  value="#request.eid"/>+'&col=${xp.colName}&table=site_style_element');">详情</a></td>

   </tr>
</s:iterator>

<tr>
    <td height="30" colspan="4">搜索页模块</td>
 </tr>
<s:action name="admin_site_style_getMetaDataByID" >
	<s:param name="id"><s:property  value="#request.sid"/></s:param>
	<s:param name="table">site_style_element</s:param>
</s:action>
<s:iterator value="#request.metaData" id="xp" status="stp">  
<tr >
...
<td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_site_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=search&id='+<s:property  value="#request.sid"/>+'&col=${xp.colName}&table=site_style_element');">详情</a></td>

   </tr>
</s:iterator>

<tr>
    <td height="30" colspan="4">评论页模块</td>
 </tr>
<s:action name="admin_site_style_getMetaDataByID" >
	<s:param name="id"><s:property  value="#request.mid"/></s:param>
	<s:param name="table">site_style_element</s:param>
...
<td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_site_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=comment&id='+<s:property  value="#request.mid"/>+'&col=${xp.colName}&table=site_style_element');">详情</a></td>
