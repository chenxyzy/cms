...
<tr><th class="tableHeaderText" height=25 colspan="2">管理员资料修改</th>
	<form method="POST" action="admin_administrator_modify.action?id=${admin.id}">
	 </center>
  <tr>
    <td width="35%" class="forumRow" align="right" >
      <p align="right">管理用户名：</p>
    </td>
  <center>
    <td width="65%" class="forumRow" >
      <p align="left">${admin.name}</p>
    </td>
  </tr>
  ...
  <center>
    <td width="65%" class="forumRow" >
      <p align="left"><input type="text" autocomplete="off" name="password" size="60">不修改密码请置空！</p>
    </td>
  </tr>
  ...
  <center>
    <td width="65%" class="forumRow" >
      <p align="left"><input type="radio" value="true" <s:if test="admin.state">checked</s:if> name="state">正常<input type="radio"  <s:if test="admin.state==false">checked</s:if> name="state" value="false">禁用</p>
    </td>
  </tr>
  ...
  <center>
    <td width="100%" class="forumRow" colspan="2">
      <p align="center"><a href="admin_administrator_queryAll.action">返回</a></p>
    </td>
  </tr>
