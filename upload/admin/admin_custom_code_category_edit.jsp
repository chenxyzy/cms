...
<tr><th class="tableHeaderText" height=25 colspan="2">代码类型修改</th>
	<form method="POST" action="admin_custom_code_category_modify.action?cc.id=${category.id}">
	 </center>
  <tr>
  ...
  <center>
    <td width="65%" class="forumRow" >
      <p align="left"><input type="text" autocomplete="off" name="cc.name" size="60" value="${category.name}"></p>
    </td>
  </tr>
  ...
  <tr>
    <td width="35%" class="forumRow" align="right" >
      <p align="right">当前位置：</p>
    </td>
  <center>
    <td width="65%" class="forumRow" >
      <p align="left"><input type="text" autocomplete="off" name="cc.currentCodeId" size="60" value="${category.currentCodeId}"></p>
    </td>
  </tr>
  ...
  <center>
    <td width="100%" class="forumRow" colspan="2">
      <p align="center"><a href="admin_custom_code_category.jsp">返回</a></p>
    </td>
  </tr>
