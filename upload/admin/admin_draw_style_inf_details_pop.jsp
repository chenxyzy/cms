...
<p>“<s:property value="#request.currentStyleName"/>”—— <b>投票系统</b> 风格模板变量详情修改 <s:property value="#request.currentModelName"/></p> 
<form method="POST" action="admin_draw_style_var_modify.action?styleID=${styleID}&id=${id}&col=${col}&table=${table}">
