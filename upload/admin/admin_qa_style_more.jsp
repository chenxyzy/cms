...
<title>问答系统风格模板详情</title>
</head>
<s:action name="admin_qa_style_findNameById">
...
<div class="aebox">
 ...
 <tr>
   ...
   <tr >
    ...
    <td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_qa_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=基本&id='+<s:property  value="#request.styleID"/>+'&col=${x.colName}&table=qa_style');">详情</a></td>
...
<s:action name="admin_qa_style_getMetaDataByID" >
	<s:param name="id"><s:property  value="#request.pid"/></s:param>
	<s:param name="table">qa_style_element</s:param>
</s:action>
...
<tr >
    ...
    <td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_qa_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=public&id='+<s:property  value="#request.pid"/>+'&col=${xp.colName}&table=qa_style_element');">详情</a></td>
...
<tr>
    <td height="30" colspan="4">index共用模块</td>
 </tr>
<s:action name="admin_qa_style_getMetaDataByID" >
...
<tr >
    ...
    <td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_qa_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=index&id='+<s:property  value="#request.iid"/>+'&col=${xp.colName}&table=qa_style_element');">详情</a></td>
...
<tr>
    <td height="30" colspan="4">nav共用模块</td>
 </tr>
<s:action name="admin_qa_style_getMetaDataByID" >
	<s:param name="id"><s:property  value="#request.nid"/></s:param>
	<s:param name="table">qa_style_element</s:param>
</s:action>
<s:iterator value="#request.metaData" id="xp" status="stp">  
<tr >
    ...
    <td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_qa_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=nav&id='+<s:property  value="#request.nid"/>+'&col=${xp.colName}&table=qa_style_element');">详情</a></td>
...
<tr>
    <td height="30" colspan="4">qa共用模块</td>
 </tr>
<s:action name="admin_qa_style_getMetaDataByID" >
	<s:param name="id"><s:property  value="#request.qid"/></s:param>
	<s:param name="table">qa_style_element</s:param>
</s:action>
<s:iterator value="#request.metaData" id="xp" status="stp">  
<tr >
    ...
    <td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_qa_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=qa&id='+<s:property  value="#request.qid"/>+'&col=${xp.colName}&table=qa_style_element');">详情</a></td>
