...
<body>
<s:action name="admin_score_schemes_find">
...
<div class="aebox">
  ...
  <div class="aeheadm">>　修改积分规则  --><b>${scheme.schemeName}</b></div>
  <div class="aeheadr"></div>
 </div>
  <div class="aelist">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
  <form method="post" action="admin_score_schemes_modify.action?id=<s:property value="#parameters.id"/>">
   
  <tr >
    <td class="list_a">发表主题得分：</td>
    <td class="list_b"><input type="text" name="scheme.valueOfNewTheme"  value="${scheme.valueOfNewTheme}" size="60"></td>
  </tr>
  <tr >
    <td class="list_a">回复主题得分：</td>
    <td class="list_b"><input type="text" name="scheme.valueOfReply"  value="${scheme.valueOfReply}" size="60"></td>
  </tr>
  <tr >
    <td class="list_a">主题被加入精华得分：</td>
    <td class="list_b"><input type="text" name="scheme.valueOfSoul"  value="${scheme.valueOfSoul}" size="60"></td>
  </tr>
  <tr >
    <td class="list_a">上传附件得分 (+)：</td>
    <td class="list_b"><input type="text" name="scheme.valueOfUpload"  value="${scheme.valueOfUpload}" size="60"></td>
  </tr>
  <tr >
    <td class="list_a">下载附件扣分 (-)：</td>
    <td class="list_b"><input type="text" name="scheme.valueOfDownload"  value="${scheme.valueOfDownload}" size="60"></td>
  </tr>
  <tr >
    <td class="list_a">最低积分：</td>
    <td class="list_b"><input type="text" name="scheme.valueOfMin"  value="${scheme.valueOfMin}" size="60"></td>
  </tr>
    <tr>
    <td width="35%" class="forumRow" align="center"  colspan="2" ><input type="submit" value="提交" name="B1"></td>
  </tr>
    <tr>
    <td width="35%" class="forumRow" align="center"  colspan="2" > <a href="./admin_bbs_integral_rule.jsp"> 返回 </a></td>
  </tr>
</form>
