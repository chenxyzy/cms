...
<tr><th class="tableHeaderText" height=25 colspan="2">外部主机编码信息修改</th>
	<form method="POST" action="admin_ehc_modify.action?ehc.id=${ehc.id}">
  <tr>
    <td width="35%" class="forumRow" align="right" >
      <p align="right">主机：</p>
    </td>
    <td width="65%" class="forumRow" >
      <p align="left"><input type="text" autocomplete="off" name="ehc.host" size="60" value="${ehc.host}"></p>
    </td>
  </tr>
  	 <tr>
    <td width="35%" class="forumRow" align="right" >
    ...
    <td width="65%" class="forumRow" >
      <p align="left"><input type="text" autocomplete="off" name="ehc.port" size="60" value="${ehc.port}"></p>
    </td>
  </tr>
  <tr>
    <td width="35%" class="forumRow" align="right" >
      <p align="right">引用类型：</p>
    </td>
    <td width="65%" class="forumRow" >
      <p align="left"><input type="radio" value="0" <s:if test="ehc.type==0">checked</s:if> name="ehc.type">下载或引用<input type="radio"  <s:if test="ehc.type==1">checked</s:if> name="ehc.type" value="1">媒体</p>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td width="65%" class="forumRow" >
      <p align="left"><textarea rows="5" name="ehc.charset" cols="66">${ehc.charset}</textarea></p>
    </td>
  </tr>
  <tr>
   ...
   <tr>
    <td width="100%" class="forumRow" colspan="2">
      <p align="center"><a href="admin_ehc_list.jsp">返回</a></p>
    </td>
  </tr>
  </form>
</table>
