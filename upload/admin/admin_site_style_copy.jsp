...
<form method="POST" id="copy"
	action="admin_site_style_copy.action?id=<s:property value="#parameters.id"/>">
<input type="text" id="newStyleName" name="newStyleName"> <input
	type="submit" value="提交" onclick="javascript:gook()" name="B1">
</form>
<a href='admin_site_style_copyToFile.action?oid=<s:property value="#parameters.id"/>'>导出为文件</a>
