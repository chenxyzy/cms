...
.itemtitle {width:800px;border:1px solid #F00;}
.upList {text-align:left;}
</style>
      ...
      <div align="center">
        <table border="0" cellpadding="0" cellspacing="14" width="100%">
          <tr>
            ...
            <p align="center"><b><font size="2">Lerx网站系统管理页面</font></b></p>
            <p><font size="2"><b>您使用的当前版本</b>：<s:text name="lerx.currentVersionNumber"></s:text> <s:text name="lerx.currentVersionBuild"></s:text></p><br>
            <div id="curr"></div>
            <br>
            </font> </p>
...
function curr(){
	$("#curr").html("正在检测...");
	$.ajax({
		url:'http://58.222.239.218:800/upd_chk.action?uid=1&clientSubVN=<s:text name="lerx.currentVersionBuild"></s:text>&callback=?',
		type: 'post',
		dataType: 'jsonp', 
		async:false,
		success:function(data){
