...
<title>抽奖系统风格模板详情</title>
</head>
<s:action name="admin_draw_style_findNameById">
...
<div class="aebox">
 <div class="aeheadbox">
  ...
  <div class="aeheadm">>　“<s:property value="#request.currentStyleName"/>”——抽奖系统风格模板详情</div>
 ...
 <tr>
   ...
   <tr >
    ...
    <td class="list_4"><a href="javascript:showStyleDetailsDiv('admin_draw_style_var_find.action?styleID='+<s:property  value="#request.styleID"/>+'&curModel=all&id='+<s:property  value="#request.styleID"/>+'&col=${x.colName}&table=draw_style');">详情</a></td>
